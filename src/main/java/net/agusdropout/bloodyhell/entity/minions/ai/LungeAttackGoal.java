...
public class LungeAttackGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        return distance >= 9.0D && distance <= 100.0D;
    }
    ...
    public void start() {
        ...
        this.entity.setPos(this.entity.getX(), this.entity.getY() + 1.0D, this.entity.getZ());

        double lungeStrength = 1.8D;
        this.entity.setDeltaMovement(direction.x * lungeStrength, 0.1D, direction.z * lungeStrength);
    }
