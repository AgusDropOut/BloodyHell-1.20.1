...
public class ModTags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> CRIMSONVEIL_CONSUMER = tag("crimson_veil_consumer");
        public static final TagKey<Item> SPELLBOOKS = tag("spellbooks");

        public static final TagKey<Item> CRIMSONVEIL_PASSIVE_RECHARGER = tag("crimson_veil_passive_recharger");
