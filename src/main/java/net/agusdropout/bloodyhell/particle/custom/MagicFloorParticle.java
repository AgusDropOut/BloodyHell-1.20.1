...
public class MagicFloorParticle extends TextureSheetParticle {
    ...
    protected MagicFloorParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, MagicFloorParticleOptions options, SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<MagicFloorParticleOptions> {
        private final SpriteSet spriteSet;
        public Provider(SpriteSet spriteSet) { this.spriteSet = spriteSet; }

        @Nullable
        @Override
        public Particle createParticle(MagicFloorParticleOptions type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new MagicFloorParticle(level, x, y, z, dx, dy, dz, type, this.spriteSet);
        }
    }
}